...
# Export drought intensity maps (KML).
if settings.intensity_maps['export']:
    print("- Exporting drought intensity map(s).")
...
#
#
#input_files = maps_to_export(input_dir=config['input_dir'])
#home_dir = 'C:/Users/rreal/OneDrive/datasets/conagua_mosemm/v2/maps'
#set_grass_env(
#        reference_array=xr.open_dataset(input_files[0]).Drought_intensity)
#    
#
#
...
## Compute and export drought magnitude maps (KML).
#
## Export time series.
#
